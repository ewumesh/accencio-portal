...
@Component({
   selector: 'ms-dash-widgets2',
   templateUrl:'./dash-widgets2-component.html',
   styleUrls: ['./dash-widgets2-component.scss'],
   encapsulation: ViewEncapsulation.None
})

export class DashWidgets2Component implements OnInit  {
